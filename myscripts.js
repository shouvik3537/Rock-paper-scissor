...
document.getElementById('rock').onclick = function(){
    return(playerSelection = document.getElementById('rock').ariaValueText);
}
document.getElementById('paper').onclick = function(){
    return(playerSelection= document.getElementById('paper').ariaValueText);
}
document.getElementById('scissor').onclick = function(){
    return(playerSelection= document.getElementById('scissor').ariaValueText);
}
